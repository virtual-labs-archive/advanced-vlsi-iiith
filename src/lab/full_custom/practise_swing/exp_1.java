...
public class exp_1 extends JApplet
{
	public  void init()
	{
						...
						//		System.out.println("k"+(((pmos_count)*3)+k));
								end_points_mat[i][j] = (((node_number)*3))+k ;
				 ...
				 else if ( img == 7)// nmos
                                  {
                                          ...
                                          for ( int i = end_pointsX[k] +8 ; i > end_pointsX[k] -7 && i>=0; i -- )
                                          {
                                                  for ( int j = end_pointsY[k] +7 ; j > end_pointsY[k] -7 && j>=0; j -- )
						  {
  ...
  //                                      wire[total_wire-1 ].update2((work_x/20)*20 , (work_y/20)*20);
			...
			public void mouseDragged(MouseEvent me)
			{
				...
				int i,j;
					...
					if(work_y<15)
						work_y=15;
					if(comp_node[node_drag].node_y+comp_node[node_drag].virtual_h<0)
						comp_node[node_drag].node_y=comp_node[node_drag].node_y-comp_node[node_drag].virtual_h+15;
					if(comp_node[node_drag].node_x+comp_node[node_drag].virtual_w<0)
						comp_node[node_drag].node_x=comp_node[node_drag].node_x-comp_node[node_drag].virtual_w+15;
						//if(node_x+virtual_w<0)
						//	node_x=node_x-virtual_w+15;
				 if ( total_comp > 0 )
                                        {
                                        for ( i = work_x -15; i < work_x + comp_node[total_comp -1].width +15; i++ )
                                        {
                                                for ( j = work_y -15 ; j < work_y + comp_node[total_comp-1].height+15 ; j++ )
                                                {
			...
			public void mouseClicked(MouseEvent m)
			{
				 ...
				 if(img_button_pressed!=-1)
				{
					...
					if(img_button_pressed==1) //|| img_button_pressed==7)
					{
						if(pmos_count >= 14)
						{
                                                       JOptionPane.showMessageDialog(null, "Circuit Can have maximum of 14 PMOS ");
						}
						else
						{
						int u;
						comp_node[total_comp] = new node(30 , 30 , img_button_pressed , 15 * 2 , 4 * 15,pmos_count);
						pmos_count++;
						comp_node[total_comp].update_mat(total_comp);
						total_comp++;
						comp_node[total_comp] = new node(30 , 120 , img_button_pressed , 15 * 2 , 4 * 15,pmos_count);
							pmos_count++;
				comp_node[total_comp].update_mat(total_comp);
				total_comp++;
						comp_node[total_comp] = new node(30 , 210 , img_button_pressed , 15 * 2 , 4 * 15,pmos_count);
							pmos_count++;
				comp_node[total_comp].update_mat(total_comp);
				total_comp++;
						comp_node[total_comp] = new node(90 , 30 , img_button_pressed , 15 * 2 , 4 * 15,pmos_count);
						pmos_count++;
						comp_node[total_comp].update_mat(total_comp);
						total_comp++;
						comp_node[total_comp] = new node(90 , 210 , img_button_pressed , 15 * 2 , 4 * 15,pmos_count);
							pmos_count++;
				comp_node[total_comp].update_mat(total_comp);
				total_comp++;
						comp_node[total_comp] = new node(180 , 30 , img_button_pressed , 15 * 2 , 4 * 15,pmos_count);
						pmos_count++;
						comp_node[total_comp].update_mat(total_comp);
						total_comp++;
						for(u=1;u<=3;u++)
						...
						comp_node[total_comp] = new node(270+(u*45) , 30 , img_button_pressed , 15 * 2 , 4 * 15,pmos_count);
							pmos_count++;
				comp_node[total_comp].update_mat(total_comp);
				total_comp++;
						}
						comp_node[total_comp] = new node(405 , 120 , img_button_pressed , 15 * 2 , 4 * 15,pmos_count);
							pmos_count++;
				comp_node[total_comp].update_mat(total_comp);
				total_comp++;
						comp_node[total_comp] = new node(405 , 210 , img_button_pressed , 15 * 2 , 4 * 15,pmos_count);
							pmos_count++;
				comp_node[total_comp].update_mat(total_comp);
				total_comp++;
						comp_node[total_comp] = new node(405 , 300 , img_button_pressed , 15 * 2 , 4 * 15,pmos_count);
							pmos_count++;
				comp_node[total_comp].update_mat(total_comp);
				total_comp++;
						comp_node[total_comp] = new node(345 , 300 , img_button_pressed , 15 * 2 , 4 * 15,pmos_count);
							pmos_count++;
				comp_node[total_comp].update_mat(total_comp);
				total_comp++;
						comp_node[total_comp] = new node(600 , 210 , img_button_pressed , 15 * 2 , 4 * 15,pmos_count);
							pmos_count++;
				comp_node[total_comp].update_mat(total_comp);
				total_comp++;
						}
					...
					else if(img_button_pressed==8)
					{
                                                       JOptionPane.showMessageDialog(null, "Circuit Cannot have capacitor ");
					...
					else if(img_button_pressed==7)
					{
						if(nmos_count>=14)
						{
                                                       JOptionPane.showMessageDialog(null, "Circuit Can have maximum of 14 NMOS ");
						}
						else
						{
						//comp_node[total_comp] = new node((work_x / 15)*15 , (work_y / 15 )*15 , img_button_pressed , 15 * 2 , 4 * 15,nmos_count);
						comp_node[total_comp] = new node(180 , 105 , img_button_pressed , 15 * 2 , 4 * 15,nmos_count);
							nmos_count++;
				comp_node[total_comp].update_mat(total_comp);
				total_comp++;
						comp_node[total_comp] = new node(30 , 300 , img_button_pressed , 15 * 2 , 4 * 15,nmos_count);
							nmos_count++;
				comp_node[total_comp].update_mat(total_comp);
				total_comp++;
						comp_node[total_comp] = new node(30 , 390 , img_button_pressed , 15 * 2 , 4 * 15,nmos_count);
							nmos_count++;
				comp_node[total_comp].update_mat(total_comp);
				total_comp++;
						comp_node[total_comp] = new node(90 , 390 , img_button_pressed , 15 * 2 , 4 * 15,nmos_count);
							nmos_count++;
				comp_node[total_comp].update_mat(total_comp);
				total_comp++;
						comp_node[total_comp] = new node(180 , 390 , img_button_pressed , 15 * 2 , 4 * 15,nmos_count);
							nmos_count++;
				comp_node[total_comp].update_mat(total_comp);
				total_comp++;
						comp_node[total_comp] = new node(180 , 300 , img_button_pressed , 15 * 2 , 4 * 15,nmos_count);
							nmos_count++;
				comp_node[total_comp].update_mat(total_comp);
				total_comp++;
						comp_node[total_comp] = new node(345 , 390 , img_button_pressed , 15 * 2 , 4 * 15,nmos_count);
							nmos_count++;
				comp_node[total_comp].update_mat(total_comp);
				total_comp++;
						comp_node[total_comp] = new node(345 , 465 , img_button_pressed , 15 * 2 , 4 * 15,nmos_count);
							nmos_count++;
				comp_node[total_comp].update_mat(total_comp);
				total_comp++;
						comp_node[total_comp] = new node(285 , 465 , img_button_pressed , 15 * 2 , 4 * 15,nmos_count);
							nmos_count++;
				comp_node[total_comp].update_mat(total_comp);
				total_comp++;
						comp_node[total_comp] = new node(405 , 465 , img_button_pressed , 15 * 2 , 4 * 15,nmos_count);
							nmos_count++;
				comp_node[total_comp].update_mat(total_comp);
				total_comp++;
						comp_node[total_comp] = new node(495 , 465 , img_button_pressed , 15 * 2 , 4 * 15,nmos_count);
							nmos_count++;
				comp_node[total_comp].update_mat(total_comp);
				total_comp++;
						comp_node[total_comp] = new node(495 , 375 , img_button_pressed , 15 * 2 , 4 * 15,nmos_count);
							nmos_count++;
				comp_node[total_comp].update_mat(total_comp);
				total_comp++;
						comp_node[total_comp] = new node(495 , 285 , img_button_pressed , 15 * 2 , 4 * 15,nmos_count);
							nmos_count++;
				comp_node[total_comp].update_mat(total_comp);
				total_comp++;
						comp_node[total_comp] = new node(600 , 300 , img_button_pressed , 15 * 2 , 4 * 15,nmos_count);
							nmos_count++;
				comp_node[total_comp].update_mat(total_comp);
				total_comp++;
						}
						...
						if(gnd_count>=3)
						{
                                                       JOptionPane.showMessageDialog(null, "Circuit Can have maximum of 3 Ground ");
						}
						else
						{
                                                 comp_node[total_comp] = new node(105 , 465 , img_button_pressed , 15 * 2 , 2 * 15,gnd_count);
                                        	 gnd_count++;
				comp_node[total_comp].update_mat(total_comp);
				total_comp++;
                                                 comp_node[total_comp] = new node(195 , 195 , img_button_pressed , 15 * 2 , 2 * 15,gnd_count);
                                        	 gnd_count++;
				comp_node[total_comp].update_mat(total_comp);
				total_comp++;
                                                 comp_node[total_comp] = new node(615 , 375 , img_button_pressed , 15 * 2 , 2 * 15,gnd_count);
                                        	 gnd_count++;
				comp_node[total_comp].update_mat(total_comp);
				total_comp++;
						}
				...
				//	       int temp = work_mat[work_x][work_y] ;
						...
						if(vdd_count>=2)
						{
                                                       JOptionPane.showMessageDialog(null, "Circuit Can have maximum of 2 VDD ");
						}
						else
						{
                                                 comp_node[total_comp] = new node(615 , 150 , img_button_pressed , 15 * 2, 3 * 15,vdd_count);
						vdd_count++;
				comp_node[total_comp].update_mat(total_comp);
				total_comp++;
                                                 comp_node[total_comp] = new node( 465, 30 , img_button_pressed , 15 * 2, 3 * 15,vdd_count);
						vdd_count++;
				comp_node[total_comp].update_mat(total_comp);
				total_comp++;
						}

		 ...
		 public class graph extends JPanel
			...
			*/
					         ...
					         g2d.setColor(Color.red);
                                        ...
                                        for( i = 0 ; i < no_values - 1 ; i++ )
                                        {
                                                g2d.drawLine(40+3*i , 140-(int)Math.round(C_in[i]*50) , 40 + 3*(i+1) , 140-(int)Math.round(C_in[i+1]*50) );
                                        }
                                        g2d.drawString("B Input ",  320 , 160 );
                                        for( i = 0 ; i < no_values - 1 ; i++ )
                                        {
                                                g2d.drawLine(40+3*i , 210-(int)Math.round(B[i]*50) , 40 + 3*(i+1) , 210-(int)Math.round(B[i+1]*50) );
                                        }
                                        g2d.drawString("A Input ",  320 , 230 );
                                        for( i = 0 ; i < no_values - 1 ; i++ )
                                        {
                                                g2d.drawLine(40+3*i , 280-(int)Math.round(A[i]*50) , 40 + 3*(i+1) , 280-(int)Math.round(A[i+1]*50) );
                                        }
                                        g2d.setColor(Color.blue);
                                        g2d.drawString("Carry Out ",  320 , 290 );
                                        for( i = 0 ; i < no_values - 1 ; i++ )
                                        {
                                                g2d.drawLine(40+3*i , 350-(int)Math.round(C_out[i]*50) , 40 + 3*(i+1) , 350-(int)Math.round(C_out[i+1]*50) );
                                        }
                                        g2d.drawString("Sum ",  320 , 350 );
   					for( i = 0 ; i < no_values - 1 ; i++ )
                                        {
                                                g2d.drawLine(40+3*i , 420-(int)Math.round(S[i]*50) , 40 + 3*(i+1) , 420-(int)Math.round(S[i+1]*50) );
                                        }
